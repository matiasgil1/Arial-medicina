                            ...
                            <div key={ev.id} className="relative pl-8 md:pl-12 border-l-2 border-slate-100 pb-2">
                                ...
                                <div className="bg-white p-5 md:p-7 rounded-2xl md:rounded-3xl border border-slate-50 shadow-sm">
                                    ...
                                    <div className="grid grid-cols-3 gap-4 pt-4 border-t border-slate-50">
                                       ...
                                       <div className="space-y-0.5"><p className="text-[7px] font-black text-slate-300 uppercase">Días</p><p className="text-[9px] font-black text-arial-orange">{ev.user.includes('Admisión') ? ev.daysSuggested : ev.daysAuthorized}</p></div>
